  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 mb-2">
        ...
        <h3 className="text-sm font-black text-indigo-900 uppercase tracking-[0.15em]">Key Results</h3>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          type="button"
          onClick={() => setKeyResult({ description: '', measure: '' })}
        ...
        {keyResultList.map((kr, index) => (
          ...
          >
            <div className="flex-1">
              <p className="text-gray-500 text-[10px] font-bold uppercase tracking-widest mb-1">Key Result #{index + 1}</p>
